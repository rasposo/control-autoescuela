        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" >
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Eliminar Cargo</h1>
                    <br>
                    ...
                    <div class="container-fluid">
                        <h4 class="h4 mb-4 text-gray-600">¿Seguro que desea eliminar el siguiente cargo?</h4>
                        <br>
                                ...
                                <div class="card shadow mb-6">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>Alumno</th><th>Fecha</th><th>Tipo</th><th>Importe</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                echo('<tr><td>'.$nombre.'</td><td>'.$fecha.'</td><td>'.$tipo.'</td><td>'.$importe.'€</td></tr>');
                                                ?>
                                            </tbody>
                                        </table>
                                    </div>
                        ...
                        <a href="eliminar-cargo.php?cargo_id=<?= $cargo->getId() ?>" class="btn btn-primary btn-icon-split" id="eliminar-clase-button">
