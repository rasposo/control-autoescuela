...
if ( isset ($_GET['pago_id']) ) {
    ...
    $pago->loadFromDB($pdo);
    $curso = new Curso($pago->getCursoId());
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid" >
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Eliminar recibo pago</h1>
                    <br>
                    ...
                    <div class="container-fluid">
                        <h4 class="h4 mb-4 text-gray-600">¿Seguro que desea eliminar el siguiente pago?</h4>
                        <br>
                                ...
                                <div class="card shadow mb-6">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>Número</th><th>Alumno</th><th>Fecha</th><th>Concepto</th><th>Importe</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                echo('<tr><td>'.$numero.'</td><td>'.$nombre.'</td><td>'.$fecha.'</td><td>'.$concepto.'</td><td>'.$importe.'€</td></tr>');
                                                ?>
                                            </tbody>
                                        </table>
                                    </div>
                        ...
                        <br>
                        <form class="user" method="POST" action="eliminar-pago.php?pago_id=<?= $pago->getId() ?>" id="motivo-eliminar-pago">
                            <div class="form-group row">
                            <div class="col-sm-4 mb-3 mb-sm-0">Introducir motivo:
                                <input type="text" class="form-control form-control-user" name="motivo"
                                    placeholder="Motivo">
                           </div>
                            </div>
                        </form>
                        <h4 class="h4 mb-4" style="color: red">Esta acción no se puede deshacer</h4>
                        <br>
                        <!-- Boton de elimimar pago -->
                        <input type="submit" value="Eliminar" form="motivo-eliminar-pago" class="btn btn-primary btn-icon-split" 
                            id="eliminar-pago-button">
                        <!-- Boton de cancelar -->
