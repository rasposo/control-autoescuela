...
?>
                ...
                <div class="container-fluid" >
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"><span style="color:brown">Nº <?= $curso->getNumeroCurso(); ?> </span>- <?= $nombre_alumno ?><span> - Curso <?= $permiso['tipo'] ?></span></h1>
                        ...
                        <div id="finalizar">
                            <div class="form-group row">
                                <div class="col-sm-2">Fecha  de inicio:
                                        <p><?= $curso->getFechaInicio() ?></p>
                                    </div>
                                    <div class="col-sm-2">Fecha  de finalización:
                                        <p><?= $curso->getFechaFinalizacion() ?></p>
                                    </div>
                                    
                                    <div class="col-sm-6">
                                        <!-- Boton para abrir de nuevo -->
                                        <a href="#" class="btn btn-primary btn-icon-split" data-toggle="modal" data-target="#reabrir-curso">
                                            <span class="text">Reabrir curso</span>
                                        </a>
                                        <!-- Boton de cancelar -->
                                        <a href="cursos-historico.php" class="btn btn-secondary btn-icon-split" id="cancelar-button">
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    <th>Fecha</th><th>Hora</th><th>Tipo</th><th>Profesor</th><th>Importe</th>
                                                </tr>
                                            </thead>
                                                ...
                                                <?php
                                                    ...
                                                    if ( ! empty($clases_ids) ) {
                                                        ...
                                                        foreach ($clases_ids as $clase) {
                                                            ...
                                                            <td>'.$profe_clase.'</td><td>'.$precio.'€</td></tr>');
                                                        }
                                                    }
                                                ?>
                                            </tbody>
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered" style="margin-bottom: 30px;">
                                            <thead>
                                                <tr>
                                                    <th>Fecha</th><th>Tipo</th><th>Importe</th>
                                                </tr>
                                            </thead>
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered" style="margin-bottom: 30px;">
                                            <thead>
                                                <tr>
                                                    <th>Número</th><th>Fecha</th><th>Concepto</th><th>Importe</th>
                                                </tr>
                                            </thead>
                                                    ...
                                                    if ( ! empty($pagos_ids) ) {
                                                        ...
                                                        foreach ( $pagos_ids as $pago ) {
                                                            ...
                                                            if ( $pag->getAnulado() !== "1" ) {
                                                                ...
                                                                //montamos la tabla
                                                                echo('<tr><td>'.$pag->getNumeroRecibo().'</td><td>'.$pag->getFecha().'</td><td>'.$pag->getConcepto().'</td><td>'.$pag->getImporte().' €</td></tr>');
                                                            }
                                                        }
                                                    };
                                                ?>
...
<!-- reabrir curso-->
<div class="modal fade" id="reabrir-curso" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">¿Seguro que quieres reabrir el curso?</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">Selecciona "Reabrir" si deseas hacerlo.</div>
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                <a class="btn btn-primary" href="../scripts/reabrirCurso.php?curso_id=<?= ($curso_id) ?>">Reabrir</a>
            </div>
        </div>
    </div>
</div>
