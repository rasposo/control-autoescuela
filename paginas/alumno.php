...
?>
                ...
                <!-- Curso matriculado -->
                <div class="card-body" id="profesor_adjudicado">
                    <h2 class="h4 mb-4 text-gray-600">Curso matriculado</h2>
                    <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="80%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>Profesor adjudicado</th>
                                    <th>Curso</th>
                                </tr>
                            </thead>
                            <tbody id="cuerpo_tabla">
                                ...
                                foreach ($cursos as $curso) { 
                                    echo "<tr>";
                                    echo "<td><a href=\"profesor.php?profesor_id=".$curso['profesor_id']."\">".$curso['nombre']." ".$curso['apellido1']." ".$curso['apellido2']."</a></td>";
                                    echo "<td><a href=\"curso.php?curso_id=".$curso['curso_id']."\">".$curso['tipo']."</td>";
                                    echo "</tr>";
                                }
                                ?>
                            </tbody>
                    ...
                    <br>
                    <div>
                        <a href="#" class="btn btn-secondary btn-icon-split" data-toggle="modal" data-target="#nuevoCurso">
                            <span class="icon text-white-50">
            ...
            <div class="modal-content">
                ...
                <form class="user" method="POST">
                    ...
                    <div class="col-sm-3">Curso:
                        <input type="text" class="form-control form-control-user" id="inputCurso" value=""
                            placeholder="Curso">
                    </div>                   
                </form>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                    <a class="btn btn-primary" href=# onclick="nuevoCurso()">Guardar</a>
                </div>
            </div>
        </div>
</div>