...
?>
                ...
                <div class="container-fluid" >
                    ...
                    <h1 class="h3 mb-4 text-gray-800"><span style="color:brown">Nº <?= $curso->getNumeroCurso(); ?> </span>- <?= $nombre_alumno ?><span> - Curso/Permiso <?= $permiso['tipo'] ?></span></h1>
                        ...
                        <form class="user" method="POST">
                            <div id="finalizar">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6">
                                        <!-- Boton para guardar -->
                                        <a href="#" class="btn btn-primary btn-icon-split" id="guardar-button" onclick="llamarAPIguardarCurso()">
                                            <span class="icon text-white-50">
                                                    ...
                                                    if ( ! empty($pagos_ids) ) {
                                                        ...
                                                        foreach ( $pagos_ids as $pago ) {
                                                            ...
                                                            if ( $pag->getAnulado() !== "1" ) {
                                                                ...
                                                                //montamos la tabla
                                                                echo('<tr><td>'.$pag->getNumeroRecibo().'</td><td>'.$pag->getFecha().'</td><td>'.$pag->getConcepto().'</td><td>'.$pag->getImporte().' €</td><td><a href="pag-eliminar/pag-eliminar-pago.php?pago_id='.$pag->getId().'">Anular</a></td></tr>');
                                                            }
                                                        }
                                                    };
                                                ?>
